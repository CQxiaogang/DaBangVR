...
- (void)setModel:(RCCRMessageModel *)model {
    ...
    [finalStr appendAttributedString:[[NSAttributedString alloc] initWithString:model.message attributes:@{NSFontAttributeName : font,NSForegroundColorAttributeName:[UIColor whiteColor],NSParagraphStyleAttributeName:paragraphStyle}]];
    ...
    self.bgView.frame = CGRectMake(0, 0, self.messsageLabel.mj_w + 8, self.messsageLabel.mj_h + 6);
}
