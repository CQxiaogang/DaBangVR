...
//    [self.naviBGView addSubview:back];
    ...
    self.userHeaderView.frame = CGRectMake(0, -naviHeight, self.view.bounds.size.width, naviHeight + JXTableHeaderViewHeight);
    self.userHeaderView.autoresizingMask = UIViewAutoresizingNone;
