...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        cell.cellTitle.text = self.titleArray[indexPath.row];
        cell.cellImgView.image = [UIImage imageNamed:self.imageArray[indexPath.row]];
    }else if(indexPath.section ==1){
        cell.cellTitle.text = self.titleArray[indexPath.row + 3];
        cell.cellImgView.image = [UIImage imageNamed:self.imageArray[indexPath.row + 3]];
    }else{
        cell.cellTitle.text = self.titleArray[indexPath.row + 5];
        cell.cellImgView.image = [UIImage imageNamed:self.imageArray[indexPath.row + 5]];
    }
