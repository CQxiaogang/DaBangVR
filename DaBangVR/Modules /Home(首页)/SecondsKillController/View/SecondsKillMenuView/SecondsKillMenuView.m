...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.backgroundColor = RGBCOLOR(52, 52, 52);
        self.pageContentScrollView.pagingEnabled = YES;
        self.pageContentScrollView.showsHorizontalScrollIndicator = NO;
    }
    return self;
}
...
- (void)setMenuTimeArray:(NSArray *)timeArray andTitleArray:(NSArray *)titleArray andNumOfShow:(int)nums{
    ...
    self.pageContentScrollView.contentSize = CGSizeMake(_timeArray.count * SCW, self.mj_h);
...
- (UIView *)menuCenterRedIndicatorView{
    if (!_menuCenterRedIndicatorView) {
        ...
        _menuCenterRedIndicatorView.backgroundColor = [UIColor colorWithRed:24/255.0 green:214/255.0 blue:220/255.0 alpha:1];
...
- (UIView *)menuCenterRedtriangleView{
    if (!_menuCenterRedtriangleView) {
        ...
        _menuCenterRedtriangleView.backgroundColor = KLightGreen;
