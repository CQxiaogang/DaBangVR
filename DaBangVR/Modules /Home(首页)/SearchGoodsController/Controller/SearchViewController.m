...
- (void)setupTopLeftButton {
    _searchBar = [self addSearchBarWithFrame:CGRectMake(0, 0, kSearchBoxW, kSearchBoxH)];
...
- (void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText {
    ...
    [NetWorkHelper POST:URl_getSearchGoodsList parameters:dic success:^(id  _Nonnull responseObject) {
