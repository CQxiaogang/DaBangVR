...
-(void)addTimeViews:(NSInteger)day {
    ...
    if (self.config.timeType == HSFTimeType_HOUR_MINUTE_SECOND) {
        ...
        px -= itemW;
        self.secondL = [[HSFTimeNumberView alloc] initWithFrame:CGRectMake(px-10, 0, itemW, height) maxNumber:9 fontSize:self.config.fontSize fontColor:self.config.fontColor bgColor:self.config.bgColor cornerRadius:self.config.cornerRadius];
        [self addSubview:self.secondL];
        
        px -= (itemW + space);
        self.secondH = [[HSFTimeNumberView alloc] initWithFrame:CGRectMake(px-10, 0, itemW, height) maxNumber:5 fontSize:self.config.fontSize fontColor:self.config.fontColor bgColor:self.config.bgColor cornerRadius:self.config.cornerRadius];
        [self addSubview:self.secondH];
        
    }
    
    px -= placeW;
    UILabel *minuteLabel = [[UILabel alloc] initWithFrame:CGRectMake(px, 0, placeW/2, height)];
    minuteLabel.textAlignment=NSTextAlignmentCenter;
    minuteLabel.text=@":";
//    minuteLabel.backgroundColor = KRedColor;
    ...
    px -= placeW-placeW/2;
    UILabel *hourLabel = [[UILabel alloc]initWithFrame:CGRectMake(px, 0, placeW/2, height)];
    hourLabel.textAlignment=NSTextAlignmentCenter;
    hourLabel.text=@":";
//    hourLabel.backgroundColor = KRedColor;
